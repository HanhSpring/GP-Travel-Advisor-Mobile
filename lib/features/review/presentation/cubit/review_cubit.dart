...
class ReviewCubit extends Cubit<ReviewState> {
  ...
  Future<void> loadReviewData(
    ...
    if (kDemoMode) {
      ...
      // ✅ Gộp logic lấy dữ liệu từ DemoReviewStore kết hợp xử lý applyRatingToAll từ develop
      final storedRating =
  ...
  // ✅ Giữ lại tính năng an toàn cho Recommender UI từ nhánh fix
  ...
  // ✅ Sử dụng hàm addImages() mới tối ưu từ nhánh develop kết hợp picker helper
