...
class _PlaceReviewScreenState extends State<PlaceReviewScreen> {
  ...
  void _submit() {
    ...
    // ✅ Track hành vi người dùng bằng ActivityService từ nhánh develop
    ...
    // ✅ Trả về kết quả 'true' khi đóng màn hình từ nhánh fix để reload UI bên ngoài
              ...
              children: [
                ...
                if (!widget.isReadOnly || _selectedTags.isNotEmpty) ...[
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: (widget.isReadOnly ? _selectedTags : kTravelReviewTags)
                        .map((tag) {
