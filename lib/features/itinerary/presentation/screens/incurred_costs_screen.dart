...
class _IncurredCostsScreenState extends State<IncurredCostsScreen> {
                  ...
                  if (widget.isCompleted)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppColors.costAmber.withValues(alpha: .28)),
                      ),
                      child: const Row(
                        children: [
                          Icon(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.cloud_off_rounded, color: AppColors.costDanger),
            ),
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 12, color: AppColors.costTextMuted),
            ),
  ...
  Widget _buildDayFilterBanner() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.filter_alt_rounded, size: 16, color: AppColors.premiumBlue),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              'Đang xem: Ngày $_dayFilterNumber',
              style: const TextStyle(fontSize: 12.5, color: AppColors.premiumBlue),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(fontSize: 11, color: AppColors.costTextMuted),
          ),
          const SizedBox(height: 6),
          travelerTile(
            label: 'Người lớn',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.groups_2_outlined, size: 19, color: AppColors.premiumBlue),
              SizedBox(width: 8),
              Text(
