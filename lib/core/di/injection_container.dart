...
// Sửa lỗi import trùng lặp ở đây
...
Future<void> initDependencies() async {
  // ── Thêm SharedPreferences lên đầu để các local datasource dùng luôn ────────
  ...
  // Đồng bộ lại cách gọi Cubit sử dụng sl() ngắn gọn thay vì gọi từng UseCase rời rạc
  ...
  sl.registerFactory(
    () => PlaceDetailCubit(
      ...
      favoriteRemoteDataSource: sl(), // Đã tự động mapping qua sl<FavoriteRemoteDataSource>() bên dưới
    ),
  );
  ...
  sl.registerLazySingleton<SavedRepository>(
    // Đồng bộ gọi qua dependency injection chính xác
    () => SavedRepositoryImpl(dataSource: sl<CollectionsDataSource>()),
  );
